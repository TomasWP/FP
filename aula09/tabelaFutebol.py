...
def printTabela(tabela):
    print()
    print("{:19s} {:>3} {:>3} {:>3} {:>3} {:>3}:{:<3} {:>3} {:>3}".format("Equipa", "J", "V", "E", "D", "GM", "GS","GM-GS", "P"))
    for reg in tabela:
        nome,v,e,d,gm,gs= reg
        print("{:19s} {:3d} {:3d} {:3d} {:3d} {:3d}:{:<3d} {:3d} {:5d}".format(nome,numJogos(reg), v, e, d, gm, gs,diferenca(reg),pontos(reg)))
...
def main():
    ...
    print("______________________B)_________________________")
    ...
    print("______________________C)_________________________")
    tab = sorted(tabela,key=lambda reg:(diferenca(reg)),reverse=True)
    printTabela(tab)
    ...
    print("______________________D)_________________________")
